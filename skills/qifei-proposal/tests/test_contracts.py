...
"""
    ...
    def test_visual_sample_rejects_direction_notes_without_image2_drafts(self) -> None:
        with tempfile.TemporaryDirectory() as temp:
            project = Path(temp)
            state = {
                "phase": "visual_sample",
    ...
    def test_visual_sample_accepts_two_registered_image2_direction_drafts(self) -> None:
        with tempfile.TemporaryDirectory() as temp:
            project = Path(temp)
            directions = []
